...
export const TECH_STACK_GROUP_COLORS: Record<TechStackGroup, string> = {
  ...
  DevOps: 'bg-orange-100 text-orange-800 dark:bg-orange-900/40 dark:text-orange-200',
  ...
  'XR & Spatial Computing': 'bg-fuchsia-100 text-fuchsia-800 dark:bg-fuchsia-900/40 dark:text-fuchsia-200',
  '3D Graphics & Engine': 'bg-lime-100 text-lime-800 dark:bg-lime-900/40 dark:text-lime-200',
